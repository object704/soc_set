...
class Zadanie
{
     ...
     *
     * @param Acme\UserBundle\Entity\PrepOfGroup $prepOfGroupPrepOfGroup
     */
    public function setPrepOfGroupPrepOfGroup(\Acme\UserBundle\Entity\PrepOfGroup $prepOfGroupPrepOfGroup)
    {
     ...
     *
     * @return Acme\UserBundle\Entity\PrepOfGroup 
     */
